...
| mvn deploy | Copies the final package to a Remote Repository (like Nexus or Artifactory) for sharing with other developers. | <ul><li>Deploy to Remote Repository</li> ⚠️**NOTE** : **USED IN** <li>CI/CD pipelines</li> <li>Nexus</li>  <li>Artifactory</li> <li>Uploads build artifact to remote repository.</li> </ul>
